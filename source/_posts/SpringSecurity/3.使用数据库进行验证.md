...
## Spring Security 校验登录流程

![Spring Security 校验登录流程](http://upload-images.jianshu.io/upload_images/3424642-7418a70abdfc7287.jpg)
...
/**
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        try {
            // 需要验证则通过 attemptAuthentication 尝试验证
...
public Authentication attemptAuthentication(HttpServletRequest request,
    ...
    // 将Request域中的 username 和 password 生成 UsernamePasswordAuthenticationToken 对象，用于 AuthenticationManager 的验证
 ...
 * AuthenticationProvider 列表将被连续尝试，直到 AuthenticationProvider 表示它能够认证传递的过来的  Authentication 对象。然后将使用该 AuthenticationProvider 尝试身份验证。
